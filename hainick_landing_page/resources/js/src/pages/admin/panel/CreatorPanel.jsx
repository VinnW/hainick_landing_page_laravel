            ...
            {hasChange && (
                <div style={{ display: "flex", gap: "0.3rem", width: "100%" }}>
                    <button
                        ...
                        onMouseEnter={(e) => {
                            if (!uploading)
                                e.currentTarget.style.background = "#263660";
                        }}
                        onMouseLeave={(e) => {
...
const CreatorPanel = () => {
        ...
        try {
            ...
            if (resCards.ok) {
                ...
                setCards((prev) =>
                    prev.map((card) => {
                        const apiItem =
                            data.find((d) => Number(d.id) === card.id) ??
                            data[card.id - 1];
                        return apiItem
    ...
    const handleCardUpdated = (id, newImageUrl) => {
        setCards((prev) =>
            prev.map((c) =>
                c.id === id ? { ...c, image_url: newImageUrl } : c,
            ),
        );
    };
            ...
            <div className="panel-wrap">
                ...
                <div className="panel-card">
                    ...
                    {dbIsEmpty && (
                        <div className="seed-banner">
                            <div className="seed-banner-text">
                                ...
                                <br />
                                Tabel <code>creators_photocard</code> perlu 20
                                row kosong dan{" "}
                                <code>creators_photocard_statistics</code> perlu
                                1 row default sebelum bisa digunakan.
                                <br />
                                Klik tombol di samping untuk membuatnya
                                otomatis,{" "}
                                <strong>atau tambahkan endpoint seed</strong> di
                                server.js terlebih dahulu (lihat komentar di
                                bawah tombol).
                            </div>
                            <div
                                style={{
                    ...
                    <p className="info-hint">
                        ℹ️ Jumlah kartu tetap 20 — tidak bisa ditambah atau
                        dihapus, hanya foto yang bisa diganti.
                    </p>
                    ...
                    <div className="stats-edit-section">
                        ...
                        >
                            <button
                                ...
                                title={
                                    !statsChanged ? "Belum ada perubahan" : ""
                                }
                            >
                                {statsLoading
                                    ? "Menyimpan…"
