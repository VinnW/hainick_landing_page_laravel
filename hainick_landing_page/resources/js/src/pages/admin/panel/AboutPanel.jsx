...
const AboutPanel = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setError(
                "Gagal memuat data. Pastikan server berjalan di " + API_URL,
            );
        } finally {
            setLoading(false);
        }
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (exists) {
                ...
                res = await fetch(
                    `${API_URL}/update-hainick-assets/talent_showcase`,
                    {
                        method: "PUT",
                        body: formData,
                    },
      ...
      `}</style>
            ...
            {showModal && (
                <div
                    ...
                    onClick={(e) =>
                        e.target === e.currentTarget && handleCancelModal()
                    }
                >
                    <div className="modal-box">
                        <div>
                            <div className="modal-title">
                                Konfirmasi Ganti Video
                            </div>
                        ...
                        {videoUrl && (
                            ...
                            >
                                ⚠️ Video lama (
                                <strong>{videoUrl.split("/").pop()}</strong>)
                                akan diganti.
                            </p>
                        )}
